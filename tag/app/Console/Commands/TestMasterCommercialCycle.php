...
class TestMasterCommercialCycle extends Command
{
    ...
    public function handle()
    {
        ...
        if (! $orden) {
            $this->error('❌ Error: No se generó la Orden de Compra automáticamente tras aprobar la Cotización.');
        ...
        if (! $cxp) {
            $this->error('❌ Error: No se generó la Cuenta por Pagar tras crearse la Orden.');
